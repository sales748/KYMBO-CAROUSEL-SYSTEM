...
.bd2{ padding:74px 76px 0; }
.bd2-top{ display:flex; align-items:baseline; justify-content:space-between; }
.bd2-wm{ font-family:var(--serif); font-weight:600; font-size:42px; }
.bd2-kick{ font-size:16px; letter-spacing:.24em; text-transform:uppercase; color:var(--muted); margin-top:9px; }
.bd2-pill{ background:var(--butter); border-radius:999px; padding:14px 28px; font-size:19px; font-weight:600; }
.bd2-grid{ display:flex; gap:78px; margin-top:74px; }
.bd2-fig{ font-family:var(--serif); font-weight:500; font-size:96px; line-height:.95; }
.bd2-lab{ font-size:17px; letter-spacing:.2em; text-transform:uppercase; color:var(--muted); margin-bottom:14px; }
.bd2-bars{ margin-top:80px; max-width:1000px; }
.bd2-bar{ margin-bottom:34px; }
.bd2-bar .t{ display:flex; justify-content:space-between; font-size:22px; margin-bottom:12px; }
.bd2-bar .track{ height:18px; border-radius:999px; background:var(--line); overflow:hidden; }
